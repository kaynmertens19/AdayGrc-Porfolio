...
const opt = {
  particles: window.width / 10 ? 10 : 1000,
  noiseScale: 0.009,
...
class Particle {
  constructor(x, y) {
    ...
    this.hue = this.hueSemen > .7 ? 20 + opt.h1 : 20 + opt.h2;
    this.sat = this.hueSemen > .7 ? opt.s1 : opt.s2;
    this.light = this.hueSemen > .7 ? opt.l1 : opt.l2;
